...
contenido_curso.append("Python")
contenido_curso.append("Variables")
contenido_curso.append("Condicionales")
contenido_curso.append("Listas")
contenido_curso.append("Bucles")
