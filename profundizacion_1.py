...
- Crear una una variable llamada cantidad_temperaturas
  para almacenar la cantidad de registros de temperaturas,
...
print(f"La suma de las temperaturas es {round(suma_total,2)}")
print(f"El promedio de las temperaturas es {round(promedio,2)}")
